...
image_list=[]
image_list_size=[]
image_start=Image.open("./imagens/group/avidaderobinhood.png")
image_startr=image_start.resize((600,100))
...
new_image = Image.new(mode='RGB',size=(5*image_list_size[0][0],
                    image_list_size[0][1]+150), color=(250,250,250))
...
new_image.paste(image_list[3],(600,100))
new_image.paste(image_list[4],(800,100))
